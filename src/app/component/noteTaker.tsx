...
export default function NotesApp() {
  ...
  return (
    <div className="flex flex-col mx-auto items-center mt-[150px] h-screen bg-background text-foreground  max-w-[500px] max-h-[700px]">
      ...
      <main className="flex-1 overflow-auto p-4">
        <div className="mb-4">
          ...
          {editingNoteId === null ? (
            ...
            <Button onClick={handleUpdateNote} className="mt-2 w-full">
              Update Note
            </Button>
          )}
        </div>
